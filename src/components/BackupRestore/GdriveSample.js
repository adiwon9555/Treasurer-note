...
export default class App extends Component {
  ...
  initialGoogle = async () => {
    ...
    console.log('@aditya user info', user);
    ...
    return (
      <View style={styles.container}>
        <TouchableHighlight
          ...
          <Text style={styles.text}>Get data from Google Drive</Text>
        </TouchableHighlight>
        <TouchableHighlight
          style={styles.buttonGetData}
          onPress={this.setDataFromGoogleDrive}>
          <Text style={styles.text}>Create data or Update data</Text>
        </TouchableHighlight>
        <Text style={styles.textData}>{JSON.parse(this.state.data)}</Text>
      </View>
    );
  }
}
