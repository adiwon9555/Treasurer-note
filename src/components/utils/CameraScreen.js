...
class CameraScreen extends Component {
  ...
  constructor(props) {
    ...
    this.props.navigation.setOptions({title: 'Camera', headerShown: false});
  }
          ...
          imageInfo
            .then((imageData) => {
              ImageCropPicker.openCropper({
                ...
                cropperToolbarTitle:
                  'Crop the image to fit to only 1 question.',
    ...
    return (
      <View style={styles.container}>
        ...
        <RNCamera
          ...
          <View style={styles.cameraFrameHeader}></View>
          <View style={styles.cameraFrameFooter}>
            ...
            <TouchableOpacity
              onPress={this.hanldeTakePicture}
              style={styles.clickWrapper}>
              <Text style={[styles.clickIcon]}>&#xf111;</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={this.deletePresentPic}
              style={styles.cameraButtons}>
              <Text style={[styles.galleryIcon]}>&#xf2ed;</Text>
